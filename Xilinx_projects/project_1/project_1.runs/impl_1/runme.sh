...
EAStep ngdbuild -intstyle ise -p xc7k70tfbg484-2 -dd _ngo -uc "bft.ucf" "bft.edf"
EAStep map -intstyle pa -w "bft.ngd"
EAStep par -intstyle pa "bft.ncd" -w "bft_routed.ncd"
EAStep trce -intstyle ise -o "bft.twr" -v 30 -l 30 "bft_routed.ncd" "bft.pcf"
EAStep xdl -secure -ncd2xdl -nopips "bft_routed.ncd" "bft_routed.xdl"
